        ...
        jQuery('.load_more_works').on('click', function () {
            ...
            if (now_load > 0) {
                ...
                for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                    loaded_object = loaded_object + '<li class="' + addon_options.items[i].columnclass + ' ' + addon_options.items[i].sortcategory + ' element added"><a href="#" class="blog-post"><div class="image-box portf_img ' + addon_options.items[i].beforecategory + '"><img alt="" src="' + addon_options.items[i].src + '"></div><div class="portf_descr"><div class="hidden-content"><h1 class="portf_title">' + addon_options.items[i].title + '</h1><div class="date-comments"> ' + addon_options.items[i].itemdate + '</div><div class="wall-masontry-citate"><i class="fa fa-quote-left"></i><p> ' + addon_options.items[i].citatedate + ' </p> <div class="citate-author"> ' + addon_options.items[i].citateauthoritem + ' </div></div><p class="blog-post-text">' + addon_options.items[i].itemtext + ' </p></div></li>';
                }
