        ...
        jQuery('.load_more_works').on('click', function () {
            ...
            if (now_load > 0) {
                ...
                for (var i = i_start - 1; i < i_start + now_load - 1; i++) {
                    loaded_object = loaded_object + '<div class="' + addon_options.items[i].columnclass + ' ' + addon_options.items[i].sortcategory + ' element added"><div class="portfolio_item"><div class="image-box portf_img"><img alt="" src="' + addon_options.items[i].src + '" /></div><a href="#"><div class="hidden-box portf_descr"><div class="hidden-content"><h6 class="portf_title"><div>' + addon_options.items[i].title + '</div></h6><div class="listing_meta"><span class="name"><div>' + addon_options.items[i].itemcategory + '</span></div></div></div></a></div></div>';
                }
